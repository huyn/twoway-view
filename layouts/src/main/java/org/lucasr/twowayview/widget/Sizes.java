...
/**
 * Created by huyaonan on 16/9/2.
 */
public class Sizes {
    public static final int NO_LANE = -1;

    private final FlowGalleryLayoutManager mLayout;
    ...
    private final SizeInfo mTempLaneInfo = new SizeInfo();
    ...
    public Sizes(FlowGalleryLayoutManager layout, TwoWayLayoutManager.Orientation orientation, Rect[] lanes, int laneSize) {
        mLayout = layout;
    ...
    public Sizes(FlowGalleryLayoutManager layout, int laneCount) {
        mLayout = layout;
    ...
    public static int calculateLaneSize(FlowGalleryLayoutManager layout, int laneCount) {
    ...
    public void getChildFrame(Rect outRect, int childWidth, int childHeight, SizeInfo laneInfo,
    ...
    public void findLane(SizeInfo outInfo, int laneSpan, TwoWayLayoutManager.Direction direction) {
